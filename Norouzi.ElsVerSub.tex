...
\title{A Tensor Framework for Alzheimer's Disease early Detection and Functional Connectivity Analysis in Resting State}
...
\end{equation}
Based on this viewpoint, each test data $X$ could be assigned to a class that its prjected version have the best approximation in the form \eqref{m2}. 
